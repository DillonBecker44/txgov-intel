...
export const AGENCIES = [
...

  {
    ...
    category:"Veterans",
    fy26_budget: 4, fy27_budget: 4, budget_confirmed: false,
    budget_source: "Estimated from LBE Art. VI (GLO/VLB combined). VLB portion of Information Resources strategy.",
    initiatives:[
...

  {
    ...
    budget_source: "Higher education IT budgets not tracked as state GR capital. Included for DIR coop and STS tracking only.",
    initiatives:[
      "Enterprise systems modernization across 11 universities",
      "Cybersecurity shared services (TAMU Cybersecurity Center)",
      "Research computing infrastructure — ACES, FASTER, Grace HPC clusters",
      "Cloud migration for administrative systems",
      "AI research computing platforms",
    ],
...

  {
    ...
    initiatives:[
      "Shared IT services across 13 UT institutions",
      "UT System Security Operations Center",
      "Research data management and computing platforms",
...
export const SUMMARY_STATS = {
  ...
  biennial_budget: 337500,
  txcc_new_biennium: 135.5,
  hhsc_it_capital_biennium: 1100,
  sb1_it_items: 38,
  hb500_it_sections: 12,
  data_updated: "May 2026",
  sb1_session: "89th Legislature",
  hb500_enacted: "June 22, 2025",
  methodology_note: "Budget figures sourced from SB1 GAA capital budget riders where confirmed, LBE by Strategy documents, LBB Issue Dockets, and agency LARs. Confirmed figures marked budget_confirmed=true. All others are directional estimates.",
};
